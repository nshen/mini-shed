...
async function build_h5(environment) {
    ...
    let bundle = await rollup_1.rollup({
        ...
        plugins: [
            ...
            copy([
                { files: `${FileHelper_1.FileHelper.CLI_PLATFORMS}/h5/*`, dest: `${FileHelper_1.FileHelper.PROJECT_DIST_H5}/` },
                { files: `${FileHelper_1.FileHelper.PROJECT_ROOT}/src/assets/**`, dest: `${FileHelper_1.FileHelper.PROJECT_DIST_H5}` },
            ], { verbose: true }),
    ...
    await bundle.write({
        name: 'shedgame',
        file: `${FileHelper_1.FileHelper.PROJECT_DIST_H5}/game.js`,
        format: 'iife',
