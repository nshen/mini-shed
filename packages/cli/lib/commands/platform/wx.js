...
async function build_wx(environment) {
    ...
    let bundle = await rollup_1.rollup({
        ...
        plugins: [
            ...
            copy([
                { files: `${FileHelper_1.FileHelper.CLI_PLATFORMS}/wx/*`, dest: `${FileHelper_1.FileHelper.PROJECT_DIST_WX}/` },
                { files: `${FileHelper_1.FileHelper.PROJECT_ROOT}/src/assets/**`, dest: `${FileHelper_1.FileHelper.PROJECT_DIST_WX}` },
            ], { verbose: true }),
    ...
    await bundle.write({
        name: 'shedgame',
        file: `${FileHelper_1.FileHelper.PROJECT_DIST_WX}/game.js`,
        format: 'cjs',
        sourcemap: environment.__DEBUG__,
        esModule: false
    });
}
exports.build_wx = build_wx;
