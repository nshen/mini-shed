...
async function build_qq(environment) {
    ...
    let bundle = await rollup_1.rollup({
        ...
        plugins: [
            ...
            copy([
                { files: `${FileHelper_1.FileHelper.CLI_PLATFORMS}/qq/*`, dest: `${FileHelper_1.FileHelper.PROJECT_DIST_QQ}/` },
                { files: `${FileHelper_1.FileHelper.PROJECT_ROOT}/src/assets/**`, dest: `${FileHelper_1.FileHelper.PROJECT_DIST_QQ}` },
            ], { verbose: true }),
    ...
    await bundle.write({
        name: 'shedgame',
        file: `${FileHelper_1.FileHelper.PROJECT_DIST_QQ}/game.js`,
        format: 'cjs',
        sourcemap: environment.__DEBUG__,
        esModule: false
    });
}
exports.build_qq = build_qq;
