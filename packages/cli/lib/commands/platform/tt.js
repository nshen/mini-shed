...
async function build_tt(environment) {
    ...
    let bundle = await rollup_1.rollup({
        ...
        plugins: [
            ...
            copy([
                { files: `${FileHelper_1.FileHelper.CLI_PLATFORMS}/tt/*`, dest: `${FileHelper_1.FileHelper.PROJECT_DIST_TT}/` },
                { files: `${FileHelper_1.FileHelper.PROJECT_ROOT}/src/assets/**`, dest: `${FileHelper_1.FileHelper.PROJECT_DIST_TT}` },
            ], { verbose: true }),
    ...
    await bundle.write({
        name: 'shedgame',
        file: `${FileHelper_1.FileHelper.PROJECT_DIST_TT}/game.js`,
        format: 'cjs',
        sourcemap: environment.__DEBUG__,
        esModule: false
    });
}
exports.build_tt = build_tt;
